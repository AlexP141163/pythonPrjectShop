    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=7, default=0.0, max_digits=20, verbose_name='Цена')),
                ('discount', models.DecimalField(decimal_places=7, default=0.0, max_digits=20, verbose_name='Скидка в %')),
