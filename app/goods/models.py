...
class Products(models.Model):
    ...
    price = models.DecimalField(default=0.00, decimal_places=7, max_digits=20, verbose_name='Цена')
    discount = models.DecimalField(default=0.00, decimal_places=4, max_digits=20, verbose_name='Скидка в %')
